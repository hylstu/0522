...
Slider.prototype = {
  ...
  initialize: function(container, bar, options) {
	this.Bar = hwafheswf(bar);
	this.Container = hwafheswf(container);
...
Drag.prototype = {
  ...
  initialize: function(drag, options) {
	...
	this._Handle = hwafheswf(this.options.Handle) || this.Drag;
	this._mxContainer = hwafheswf(this.options.mxContainer) || null;
