...
$(function(){
	...
	info_format	: function(value) {
		...
		switch (value) {
			case 1 : 
				info	= '<div class="info-box" style="color:#a4a4a4;">1分&nbsp;很不满意</div>';
				break;
			case 2 : 
				info	= '<div class="info-box" style="color:#a4a4a4;">2分&nbsp;不满意</div>';
				break;
			case 3 : 
				info	= '<div class="info-box" style="color:#fbae03;">3分&nbsp;一般</div>';
				break;
			case 4 : 
				info	= '<div class="info-box" style="color:#fbae03;">4分&nbsp;满意</div>';
				break;
			case 5 : 
				info	= '<div class="info-box" style="color:#c80000;">5分&nbsp;非常满</div>';
				break;
			default :
				info = value;
				break;
